...
public class S_ALIASESX_EGG implements IDstNode {
LEX_EGG scanner;
  S_ALIASESX_EGG() {
	}
  S_ALIASESX_EGG(LEX_EGG scanner, boolean eval) {
...
int [] sync= new int[0];
  ...
  private void regle24() throws Exception {
	...
	//appel
if  (att_eval)	  action_auto_inh_24(x_3, x_5);
	x_2.analyser(LEX_EGG.token_t_virgule);
	  addChild(x_2);
	x_3.analyser(LEX_EGG.token_t_alias);
	  addChild(x_3);
if  (att_eval)	  action_alias_24(x_3, x_5);
	x_5.analyser() ;
	  addChild(x_5);
	 offset =x_2.getOffset();
	 length =x_5.getOffset() + x_5.getLength() - offset;
  }
private void action_alias_24(T_EGG x_3, S_ALIASESX_EGG x_5) throws Exception {
try {
// instructions
(this.att_lex).addName(x_3.att_txt);
}catch(RuntimeException e) {	   att_scanner._interrompre(IProblem.Internal,att_scanner.getBeginLine(),ICoreMessages.id_EGG_runtime_error, CoreMessages.EGG_runtime_error,new Object[] { "EGG", "#alias","ALIASESX -> t_virgule t_alias #alias ALIASESX1 ;"});
}
  }
private void action_auto_inh_24(T_EGG x_3, S_ALIASESX_EGG x_5) throws Exception {
try {
// instructions
x_5.att_lex=this.att_lex;
}catch(RuntimeException e) {	   att_scanner._interrompre(IProblem.Internal,att_scanner.getBeginLine(),ICoreMessages.id_EGG_runtime_error, CoreMessages.EGG_runtime_error,new Object[] { "EGG", "#auto_inh","ALIASESX -> t_virgule t_alias #alias ALIASESX1 ;"});
}
  }
