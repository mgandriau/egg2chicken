...
public class S_APRTERME_EXPREG implements IDstNode {
LEX_EXPREG scanner;
  S_APRTERME_EXPREG() {
	}
  S_APRTERME_EXPREG(LEX_EXPREG scanner, boolean eval) {
...
int [] sync= new int[0];
  ...
  private void regle8() throws Exception {
	...
	S_TERME_EXPREG x_3 = new S_TERME_EXPREG(scanner,att_eval) ;
	S_APRTERME_EXPREG x_4 = new S_APRTERME_EXPREG(scanner,att_eval) ;
	//appel
if  (att_eval)	  action_auto_inh_8(x_3, x_4);
	x_2.analyser(LEX_EXPREG.token_ou);
	  addChild(x_2);
	x_3.analyser() ;
	  addChild(x_3);
	x_4.analyser() ;
...
if  (att_eval)	  action_gen_8(x_3, x_4);
  ...
  private void regle9() throws Exception {
	...
	//declaration
	//appel
if  (att_eval)	  action_gen_9();
   length = 0; offset = scanner.getPreviousOffset()+ scanner.getPreviousLength();  }
private void action_auto_inh_8(S_TERME_EXPREG x_3, S_APRTERME_EXPREG x_4) throws Exception {
try {
// instructions
...
}catch(RuntimeException e) {	   att_scanner._interrompre(IProblem.Internal,att_scanner.getBeginLine(),ICoreMessages.id_EGG_runtime_error, CoreMessages.EGG_runtime_error,new Object[] { "EXPREG", "#auto_inh","APRTERME -> ou TERME APRTERME1 #gen ;"});
}
  }
private void action_gen_9() throws Exception {
try {
// instructions
this.att_code="";
}catch(RuntimeException e) {	   att_scanner._interrompre(IProblem.Internal,att_scanner.getBeginLine(),ICoreMessages.id_EGG_runtime_error, CoreMessages.EGG_runtime_error,new Object[] { "EXPREG", "#gen","APRTERME -> #gen ;"});
}
  }
private void action_gen_8(S_TERME_EXPREG x_3, S_APRTERME_EXPREG x_4) throws Exception {
try {
// instructions
this.att_code=(("|"+x_3.att_code)+x_4.att_code);
}catch(RuntimeException e) {	   att_scanner._interrompre(IProblem.Internal,att_scanner.getBeginLine(),ICoreMessages.id_EGG_runtime_error, CoreMessages.EGG_runtime_error,new Object[] { "EXPREG", "#gen","APRTERME -> ou TERME APRTERME1 #gen ;"});
}
  }
