...
public class S_OP_EXPREG implements IDstNode {
LEX_EXPREG scanner;
  S_OP_EXPREG() {
	}
  S_OP_EXPREG(LEX_EXPREG scanner, boolean eval) {
...
if  (att_eval)	  action_gen_19();
  ...
  private void regle18() throws Exception {
	...
	//appel
	x_2.analyser(LEX_EXPREG.token_interro);
	  addChild(x_2);
if  (att_eval)	  action_gen_18();
  ...
  private void regle17() throws Exception {
	...
	T_EXPREG x_2 = new T_EXPREG(scanner ) ;
	//appel
	x_2.analyser(LEX_EXPREG.token_plus);
	  addChild(x_2);
if  (att_eval)	  action_gen_17();
  ...
  private void regle16() throws Exception {
	...
	T_EXPREG x_2 = new T_EXPREG(scanner ) ;
	//appel
	x_2.analyser(LEX_EXPREG.token_etoile);
	  addChild(x_2);
if  (att_eval)	  action_gen_16();
	 offset =x_2.getOffset();
	 length =x_2.getOffset() + x_2.getLength() - offset;
  }
private void action_gen_18() throws Exception {
try {
// instructions
this.att_code="?";
}catch(RuntimeException e) {	   att_scanner._interrompre(IProblem.Internal,att_scanner.getBeginLine(),ICoreMessages.id_EGG_runtime_error, CoreMessages.EGG_runtime_error,new Object[] { "EXPREG", "#gen","OP -> interro #gen ;"});
}
  }
private void action_gen_19() throws Exception {
try {
// instructions
this.att_code="";
}catch(RuntimeException e) {	   att_scanner._interrompre(IProblem.Internal,att_scanner.getBeginLine(),ICoreMessages.id_EGG_runtime_error, CoreMessages.EGG_runtime_error,new Object[] { "EXPREG", "#gen","OP -> #gen ;"});
}
  }
...
// instructions
this.att_code="*";
}catch(RuntimeException e) {	   att_scanner._interrompre(IProblem.Internal,att_scanner.getBeginLine(),ICoreMessages.id_EGG_runtime_error, CoreMessages.EGG_runtime_error,new Object[] { "EXPREG", "#gen","OP -> etoile #gen ;"});
}
  }
...
// instructions
this.att_code="+";
}catch(RuntimeException e) {	   att_scanner._interrompre(IProblem.Internal,att_scanner.getBeginLine(),ICoreMessages.id_EGG_runtime_error, CoreMessages.EGG_runtime_error,new Object[] { "EXPREG", "#gen","OP -> plus #gen ;"});
}
  }
  public void analyser () throws Exception {
    scanner.lit ( 1 ) ;
    switch ( scanner.fenetre[0].code ) {
      case LEX_EXPREG.token_etoile : // 19
        regle16 () ;
      break ;
      case LEX_EXPREG.token_plus : // 20
        regle17 () ;
      break ;
      case LEX_EXPREG.token_interro : // 21
        regle18 () ;
      break ;
