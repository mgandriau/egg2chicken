...
public class S_ATTRIBUTS_EGG implements IDstNode {
LEX_EGG scanner;
  S_ATTRIBUTS_EGG() {
	}
  S_ATTRIBUTS_EGG(LEX_EGG scanner, boolean eval) {
...
int [] sync= new int[0];
  ...
  private void regle3() throws Exception {
	...
	//declaration
	S_ATTRIBUT_EGG x_2 = new S_ATTRIBUT_EGG(scanner,att_eval) ;
	S_ATTRIBUTS_EGG x_3 = new S_ATTRIBUTS_EGG(scanner,att_eval) ;
	//appel
...
private void action_auto_inh_3(S_ATTRIBUT_EGG x_2, S_ATTRIBUTS_EGG x_3) throws Exception {
try {
// instructions
...
}catch(RuntimeException e) {	   att_scanner._interrompre(IProblem.Internal,att_scanner.getBeginLine(),ICoreMessages.id_EGG_runtime_error, CoreMessages.EGG_runtime_error,new Object[] { "EGG", "#auto_inh","ATTRIBUTS -> ATTRIBUT ATTRIBUTS1 ;"});
}
  }
