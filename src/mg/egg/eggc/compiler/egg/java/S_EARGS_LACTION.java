...
public class S_EARGS_LACTION implements IDstNode {
LEX_LACTION scanner;
  S_EARGS_LACTION() {
	}
  S_EARGS_LACTION(LEX_LACTION scanner, boolean eval) {
...
int [] sync= new int[0];
  ...
  private void regle28() throws Exception {
	...
	S_EARGS_LACTION x_5 = new S_EARGS_LACTION(scanner,att_eval) ;
	//appel
if  (att_eval)	  action_auto_inh_28(x_3, x_5);
	x_2.analyser(LEX_LACTION.token_t_virgule);
	  addChild(x_2);
	x_3.analyser() ;
	  addChild(x_3);
if  (att_eval)	  action_add_28(x_3, x_5);
	x_5.analyser() ;
	  addChild(x_5);
if  (att_eval)	  action_gen_28(x_3, x_5);
  ...
  private void regle27() throws Exception {
	...
	//declaration
	//appel
if  (att_eval)	  action_gen_27();
   length = 0; offset = scanner.getPreviousOffset()+ scanner.getPreviousLength();  }
private void action_auto_inh_28(S_EXPR_LACTION x_3, S_EARGS_LACTION x_5) throws Exception {
try {
// instructions
...
}catch(RuntimeException e) {	   att_scanner._interrompre(IProblem.Internal,att_scanner.getBeginLine(),ICoreMessages.id_EGG_runtime_error, CoreMessages.EGG_runtime_error,new Object[] { "LACTION", "#auto_inh","EARGS -> t_virgule EXPR #add EARGS1 #gen ;"});
}
  }
private void action_add_28(S_EXPR_LACTION x_3, S_EARGS_LACTION x_5) throws Exception {
try {
// instructions
(this.att_hargs).add(x_3.att_code);
(this.att_htypes).add(x_3.att_type);
x_5.att_htypes=this.att_htypes;
}catch(RuntimeException e) {	   att_scanner._interrompre(IProblem.Internal,att_scanner.getBeginLine(),ICoreMessages.id_EGG_runtime_error, CoreMessages.EGG_runtime_error,new Object[] { "LACTION", "#add","EARGS -> t_virgule EXPR #add EARGS1 #gen ;"});
}
  }
private void action_gen_28(S_EXPR_LACTION x_3, S_EARGS_LACTION x_5) throws Exception {
try {
// instructions
this.att_args=x_5.att_args;
this.att_types=x_5.att_types;
}catch(RuntimeException e) {	   att_scanner._interrompre(IProblem.Internal,att_scanner.getBeginLine(),ICoreMessages.id_EGG_runtime_error, CoreMessages.EGG_runtime_error,new Object[] { "LACTION", "#gen","EARGS -> t_virgule EXPR #add EARGS1 #gen ;"});
}
  }
private void action_gen_27() throws Exception {
try {
// instructions
this.att_args=this.att_hargs;
this.att_types=this.att_htypes;
}catch(RuntimeException e) {	   att_scanner._interrompre(IProblem.Internal,att_scanner.getBeginLine(),ICoreMessages.id_EGG_runtime_error, CoreMessages.EGG_runtime_error,new Object[] { "LACTION", "#gen","EARGS -> #gen ;"});
}
  }
