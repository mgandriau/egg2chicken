...
public class S_XTYPE_LACTION implements IDstNode {
LEX_LACTION scanner;
  S_XTYPE_LACTION() {
	}
  S_XTYPE_LACTION(LEX_LACTION scanner, boolean eval) {
...
if  (att_eval)	  action_auto_inh_9(x_3, x_4);
	...
	x_4.analyser() ;
	  addChild(x_4);
if  (att_eval)	  action_add_9(x_3, x_4);
...
private void action_auto_inh_9(S_TYPE_LACTION x_3, S_XTYPE_LACTION x_4) throws Exception {
try {
// instructions
x_3.att_res=this.att_res;
x_4.att_res=this.att_res;
}catch(RuntimeException e) {	   att_scanner._interrompre(IProblem.Internal,att_scanner.getBeginLine(),ICoreMessages.id_EGG_runtime_error, CoreMessages.EGG_runtime_error,new Object[] { "LACTION", "#auto_inh","XTYPE -> t_virgule TYPE XTYPE1 #add ;"});
}
  }
...
}catch(RuntimeException e) {	   att_scanner._interrompre(IProblem.Internal,att_scanner.getBeginLine(),ICoreMessages.id_EGG_runtime_error, CoreMessages.EGG_runtime_error,new Object[] { "LACTION", "#gen","XTYPE -> #gen ;"});
}
  }
private void action_add_9(S_TYPE_LACTION x_3, S_XTYPE_LACTION x_4) throws Exception {
try {
// instructions
(x_4.att_pars).insertElementAt(x_3.att_type, 0);
this.att_pars=x_4.att_pars;
}catch(RuntimeException e) {	   att_scanner._interrompre(IProblem.Internal,att_scanner.getBeginLine(),ICoreMessages.id_EGG_runtime_error, CoreMessages.EGG_runtime_error,new Object[] { "LACTION", "#add","XTYPE -> t_virgule TYPE XTYPE1 #add ;"});
}
  }
