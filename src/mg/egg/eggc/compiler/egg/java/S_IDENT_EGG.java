...
public class S_IDENT_EGG implements IDstNode {
LEX_EGG scanner;
  S_IDENT_EGG() {
	}
  S_IDENT_EGG(LEX_EGG scanner, boolean eval) {
...
private void action_gen_20(T_EGG x_2) throws Exception {
try {
// instructions
this.att_code=x_2.att_txt;
}catch(RuntimeException e) {	   att_scanner._interrompre(IProblem.Internal,att_scanner.getBeginLine(),ICoreMessages.id_EGG_runtime_error, CoreMessages.EGG_runtime_error,new Object[] { "EGG", "#gen","IDENT -> t_ident #gen ;"});
}
  }
